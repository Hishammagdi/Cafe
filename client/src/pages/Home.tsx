...
export default function Home() {
  ...
  const galleryImages = [
    { src: '/manus-storage/turkish_coffee_34783ec5.jpg', alt: 'قهوة تركي' },
    { src: '/manus-storage/lemon_mint_e62dadd4.jpg', alt: 'ليمون نعناع' },
    { src: '/manus-storage/om_ali_8ecd71f0.jpg', alt: 'أم علي' },
    { src: '/manus-storage/hero_coffee_breakfast_eda2edab.jpg', alt: 'فطار مصري' }
  ];
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative h-screen bg-cover bg-center flex items-center justify-center overflow-hidden"
        style={{ backgroundImage: `url('/manus-storage/hero_coffee_breakfast_eda2edab.jpg')` }}>
